...
public class SectionController : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        // zPos initiale = pos ver + moitié de la taille de la section - 1.5 de marge pour éviter les bords visibles
        float zPos = worm.transform.position.z + (sectionSizeZ / 2) - 1.5f;
