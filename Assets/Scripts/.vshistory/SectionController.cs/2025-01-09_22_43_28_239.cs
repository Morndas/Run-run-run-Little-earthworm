...
public class SectionController : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        sectionZSize = SectionsInScene[0].GetComponentInChildren<Transform>().Find("Ground").transform.localScale.z;
        ...
        float zPos = worm.transform.position.z + (sectionZSize / 2) - 1.5f;
