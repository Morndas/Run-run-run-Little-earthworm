...
public class MoveWorm : MonoBehaviour
{
    ...
    private IEnumerator SwitchLane(int targetLineIndex, float duration)
    {
        float timeElapsed = 0;
        ...
        transform.localPosition = new Vector3(targetLineIndex * LANE_SIZE_X, transform.localPosition.y, transform.localPosition.z);
    }
