...
public class MoveWorm : MonoBehaviour
{
    ...
    private IEnumerator SmoothLaneSwitch(Vector3 originPos, int targetLineIndex, float duration)
    {
        float timeElapsed = 0;
        Vector3 targetPos = new Vector3(targetLineIndex * LANE_SIZE_X, originPos.y, originPos.z);
