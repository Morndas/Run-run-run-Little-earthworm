...
public class MoveWorm : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        Vector3 rayPosL = new Vector3((transform.position.x - LANE_SIZE_X), transform.position.y, (transform.position.z - wormCollider.bounds.size.z / 2)+2);
        Vector3 rayPosR = new Vector3((transform.position.x + LANE_SIZE_X), transform.position.y, (transform.position.z - wormCollider.bounds.size.z / 2)+2);
