...
public class MoveWorm : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        wormContainerTransform.position += new Vector3(0, 0, currentForwardSpeed * Time.deltaTime);
        ...
        Vector3 rayPosR = new Vector3((transform.position.x + LANE_SIZE_X), transform.position.y, (transform.position.z - wormCollider.bounds.size.z / 2));
