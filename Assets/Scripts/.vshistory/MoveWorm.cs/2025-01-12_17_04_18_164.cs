...
public class MoveWorm : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        {
            Debug.DrawRay(transform.position, transform.TransformDirection(Vector3.left) * hitInfoL.distance, Color.green);
        }
        ...
        {
            Debug.DrawRay(transform.position, transform.TransformDirection(Vector3.right) * hitInfoR.distance, Color.green);
        }
